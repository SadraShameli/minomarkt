...
class OptionsGeneral extends BaseOptions
{
    public static string $pageTitle = 'General Settings';

    public static string $menuTitle = 'General';

    public static string $menuSlug = 'general';

    protected bool $isMain = true;
